...
def frnc(file):
    ...
    Frnc_info_201901 = Frnc_info_201901[(Frnc_info_201901['업종대분류코드'] == 1) & (Frnc_info_201901['가동코드'] == 1)]
...
def frnc1(file):
    ...
    Frnc_info_201901 = Frnc_info_201901[(Frnc_info_201901['업종대분류'] == 1) & (Frnc_info_201901['가동여부'] != 2)]
    Frnc_info_201901
...
# 결과 저장
result.to_csv('outputall/상권_숙박.csv',sep=',')
